                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/accounts.CreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/accounts.UpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/budgets/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Jumlah bulan ke belakang (default 3, max 12)",
                        "name": "months",
                        "in": "query"
                    }
                ],
